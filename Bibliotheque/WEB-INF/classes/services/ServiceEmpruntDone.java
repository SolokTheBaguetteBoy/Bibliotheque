...
public class ServiceEmpruntDone extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException { 
		...
		out.println("Document emprunté : " + request.getParameter("idDoc"));
		...
		try {
			int test = Mediatheque.getInstance().emprunt(Mediatheque.getInstance().getDocument(in), a);
			//out.println(" " + test);
